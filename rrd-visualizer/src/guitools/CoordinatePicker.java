...
public class CoordinatePicker {
	...
	public void showDialog() {
		...
		JScrollPane appletPanel = new JScrollPane(mcp,
	...
	class ImageMouseListener implements MouseListener {
		public void mousePressed(MouseEvent e) {
			...
			if ((e.getModifiers() & MouseEvent.BUTTON1_MASK) != 0) {
				// showCoordinates.setText("Coordinates: " + dot.x + ":" +
				// dot.y);
				if (exist) {
					mcp.clearSelection();
					rect = false;
		...
		public void mouseReleased(MouseEvent e) {
			 ...
			 * imagePanel.setBufferedImage(prop2Show.getDescription(),
			 * tmpLayer); imagePanel.repaint();
			 */
			if ((e.getModifiers() & MouseEvent.BUTTON1_MASK) != 0) {
				if (mouseX != e.getX() && mouseY != e.getY()) {
					...
					resultCoord.setText("X: " + x + " Y: " + y + " Width: " + w
							+ " Height: " + h);
					exist = true;
	...
	class MyCoordinatePicker extends Applet {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -425129346796933614L;
